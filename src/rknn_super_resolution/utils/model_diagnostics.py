...
from rknn_super_resolution.models import PhaseRLFNSR, SRInput, forward_sr, split_sr_input
...
class ForwardDiagnosticsTracker:
    ...
    def _register(self) -> None:
        ...
        self._handles.append(core.residual_head.register_forward_hook(save_residual))
